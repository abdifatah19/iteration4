...
<html>
    ...
    <body>
        ...
        <div class="container py-5" style="background-color: #25bfca; padding: 0px; margin-top: 0px;">
            <div class="row" style=" padding: 0px;">
                <div class="col-lg-10 mx-auto bg-white rounded shadow" style="padding: 0px; margin-top: 0px">
                    <div class="container" style="background-color: white; padding: 10px; margin-top: 0px; width: 100%">
                        <div class="table table-hover" style="width: 90%; margin-top: 0px;">
                            <div style="height: 400px; overflow-y: auto; width: 110%; padding-left: 0px; margin-top: 0px;">
                                <div id="table">
